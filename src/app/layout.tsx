...
export const metadata: Metadata = {
  title: "AI Solutions - Voice Agents, Automations & Chatbots",
  description: "Empower your small business with intelligent AI solutions. Voice agents, process automations, and smart chatbots that work 24/7 to reduce costs and boost efficiency.",
  keywords: "AI solutions, voice agents, chatbots, business automation, AI automation, small business",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "AI Solutions - Intelligent Automation for Small Business",
    description: "Transform your business with voice agents, AI automations, and chatbots",
    type: "website",
